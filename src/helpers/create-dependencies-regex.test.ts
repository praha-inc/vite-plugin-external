...
import { createDependenciesRegex } from './create-dependencies-regex';

import type { PackageJson } from '../types';

describe('createDependenciesRegex', () => {
  ...
  it('should return undefined if packageJson has no dependencies', () => {
    expect(createDependenciesRegex(basePackageJson)).toBeUndefined();
  });
  ...
  it('should return a regex that matches dependencies', () => {
    ...
    const regex = createDependenciesRegex(packageJson);
